...
class Mixin:
    def initializeVariables(self):
        '''
        Function to define variables that has to be reinitialized each time
    ...
    def initUI(self, *args, **kwargs):
        '''
        Function to create toolbar, data browser, panel of tabs of images,
        error charts and calculated parameters visualization
        '''
