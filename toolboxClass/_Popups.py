...
class Mixin:
    ...
    def add_session_popup(self):
        ...
        tk.Label(self.m_frm[0], text='Select file type to load')\
        ...
        tk.Button(self.m_frm[3], text="Start", command=self.add_session)\
            .grid(row=2, column=0)
        tk.Button(self.m_frm[3], text="Cancel", command=self.popup.destroy)\
            .grid(row=2, column=1)
        ...
        tk.Label(self.m_frm[1], text='Pattern type ')\
            .grid(row=0, column=0, sticky=tk.W)
        tk.OptionMenu(self.m_frm[1], self.pattern_type, "Chessboard",
                      "Asymmetric Grid", "Symmetric Grid").grid(row=1,
                                                                column=0,
                                                                sticky=tk.W
                                                                + tk.E)
        tk.Label(self.m_frm[1], text='Pattern width ').grid(row=2,
                                                            column=0,
                                                            sticky=tk.W)
        ...
        tk.Label(self.m_frm[1], text='Pattern height ').grid(row=5,
                                                             column=0,
                                                             sticky=tk.W)
        ...
        tk.Label(self.m_frm[1],
                 text='Feature distance (mm) ').grid(row=8, column=0,
                                                     sticky=tk.W)
        ...
        tk.Label(self.m_frm[2], text='Image width ').grid(row=0, column=0,
                                                          sticky=tk.W)
        ...
        tk.Label(self.m_frm[2], text='Image height ').grid(row=3, column=0,
                                                           sticky=tk.W)
    ...
    def popupmsg(self):
        ...
        tk.Button(self.popup, text="Okay",
    ...
    def play_popup(self):
        ...
        tk.Label(self.popup,
                 text='How to get camera parameters?').grid(row=0, column=0,
                                                            sticky=tk.E
                                                            + tk.W
                                                            + tk.N)
        tk.OptionMenu(self.popup, self.how_to_calibrate,
                      "Clustering calculation", "Load from file",
        ...
        tk.Button(self.m_frm[0], text="Intrinsics 1 camera",
        ...
        if self.m_stereo:
            tk.Button(self.m_frm[0], text="Intrinsics 2 camera",
                      command=lambda: self.assign_filename(1)).grid(row=3,
                                                                    column=0,
                                                                    sticky=tk.E
                                                                    + tk.W
                                                                    + tk.N)
            tk.Button(self.m_frm[0], text="Extrinsics",
        ...
        tk.Label(self.m_frm[1], text='Number of images (n) ').grid(row=1,
                                                                   column=0,
                                                                   sticky=tk.W)
        ...
        tk.Label(self.m_frm[1], text='Number of groups (k) ').grid(row=3,
                                                                   column=0,
                                                                   sticky=tk.W)
        ...
        tk.Label(self.m_frm[1],
                 text='Number of elements per group (r) ').grid(row=6,
                                                                column=0,
                                                                sticky=tk.W)
    ...
    def popupmsg_deleting(self):
        ...
        tk.Button(self.popup, text="Yes", command=self.del_all)\
            .grid(row=1, column=0, sticky=tk.W + tk.E)
        tk.Button(self.popup, text="Cancel", command=self.popup.destroy)\
